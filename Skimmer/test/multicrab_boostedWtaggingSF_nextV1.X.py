...
def submitJobs( job, inputFiles, unitJobs ):
    ...
    requestname = 'boostedWtagging_Skimmer_'+ job + '_' +options.version
    print requestname
    config.JobType.scriptExe = 'runPostProc_MC.sh'#+options.datasets+'.sh'
    config.JobType.inputFiles = ['PSet.py','runPostProc_MC.sh', 'jetObservables_crab_extNanoAOD_MC.py' ,'haddnano.py', 'keep_and_drop.txt']# options.pythonFile ,'haddnano.py', 'keep_and_drop.txt']
